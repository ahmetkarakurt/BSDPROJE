...
{
    public class BaseXtraForms : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void NewMethod(EventArgs e)
        {
            if (FormBorderStyle != FormBorderStyle.FixedSingle || FormBorderStyle != FormBorderStyle.FixedToolWindow || FormBorderStyle != FormBorderStyle.Sizable)
            {
