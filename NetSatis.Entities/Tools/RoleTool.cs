...
namespace NetSatis.Entities.Tools
{
    ...
    {
        public static BSD_TBL_Kullanici KullaniciEntity;
        public static string Sirket;
      //  public static Sube SubeEntity;
        public static void RolleriYukle(XtraForm form)
        {
            NetSatisContext context = new NetSatisContext();
            foreach (var item in context.BSD_TBL_KullaniciRolleri.Where(c => c.KullaniciAdi == KullaniciEntity.KullaniciAdi && c.FormAdi == form.Name && c.Yetki == false).ToList())
            {
        ...
        {
            NetSatisContext context = new NetSatisContext();
            foreach (var item in context.BSD_TBL_KullaniciRolleri.Where(c => c.KullaniciAdi == KullaniciEntity.KullaniciAdi && c.FormAdi == "FrmAnaMenu" && c.Yetki == false).ToList())
            {
        ...
        public   static void SeciliSirket(string SeciliSirket)
        {
            Sirket = SeciliSirket;
        }
    }
